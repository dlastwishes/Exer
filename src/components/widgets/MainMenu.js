    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: "row" }}>
          <TouchableOpacity style={styles.click} onPress={this.props.onPressBuyETH}>
            <View
              style={{
          ...
          <TouchableOpacity style={styles.click} onPress={this.props.onPressMyQR}>
            <View
              style={{
                flexDirection: "column",
                alignContent: "center",
          ...
          <TouchableOpacity style={styles.click} onPress={this.props.onPressBalance}>
            <View
              style={{
                flexDirection: "column",
                alignContent: "center",
